...
🌱 Estoy aprendiendo: [![My Skills](https://skillicons.dev/icons?i=html,css,js,java,python,bash,arduino,php,git,github,postgres,mysql,linux,ubuntu,mint,debian,raspberrypi,windows&perline=6)](https://skillicons.dev)
